...
def ensure_default_categories():
    """Create default categories when none exist in the database."""
...
class UserProfile(models.Model):
    ...
    avatar = models.ImageField(max_length=255, upload_to='avatars/', null=True, blank=True)
    ...
    def __str__(self):
        return f"Profile for {getattr(self.user, 'username', 'Unknown')}"
